...
(() => {
  ...
  const MESSAGES = {
    en: {
      ...
      "activitySearch.aria": "Search activities",
      "activitySearch.placeholder": "Search activities…",
      "activitySearch.clear": "Clear activity search",
      "activitySearch.disabledEvents": "Switch to Activities or All to search activities",
      ...
      "loading.categoryMore": "Loading more {category} results…",
    ...
    fr: {
      ...
      "activitySearch.aria": "Rechercher des activités",
      "activitySearch.placeholder": "Rechercher une activité…",
      "activitySearch.clear": "Effacer la recherche d'activités",
      "activitySearch.disabledEvents": "Passez sur Activités ou Tout pour rechercher",
      ...
      "loading.categoryMore": "Chargement de résultats {category}…",
