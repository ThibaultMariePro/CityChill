...
(() => {
  ...
  const MESSAGES = {
    en: {
      ...
      "filter.calendar.hint": "Pick a start day, then an end day. Tap the same day twice for a single day.",
      "filter.calendar.clear": "Clear dates",
      "filter.calendar.prev": "Previous month",
      "filter.calendar.next": "Next month",
    ...
    fr: {
      ...
      "filter.calendar.hint": "Choisissez un jour de début, puis un jour de fin. Touchez deux fois le même jour pour une seule date.",
      "filter.calendar.clear": "Effacer les dates",
      "filter.calendar.prev": "Mois précédent",
      "filter.calendar.next": "Mois suivant",
